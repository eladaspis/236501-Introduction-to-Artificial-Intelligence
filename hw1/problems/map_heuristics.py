...
class AirDistHeuristic(HeuristicFunction):
    ...
    def estimate(self, state: GraphProblemState) -> float:
        ...
        temp_junction = self.problem.streets_map[self.problem.target_junction_id]
        my_junction = self.problem.streets_map[state.junction_id]
        return my_junction.calc_air_distance_from(temp_junction)
